...
--beautiful.wallpaper = "~/.config/awesome/themes/wallpaper"
...
awful.key({           }, "Print",
    function ()
        awful.util.spawn("scrot -e 'mv $f ~/Images/screenshots/ 2>/dev/null'", false) end, 
        {description = "print screen", group = "screen"}), 

-- Standard program
awful.key({ modkey,           }, "Return", function () awful.spawn(terminal) end,
          {description = "open a terminal", group = "launcher"}),
awful.key({ modkey, "Control" }, "k", awesome.restart,
...
clientkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift"   }, "f",      function (c) c:kill()                         end,
